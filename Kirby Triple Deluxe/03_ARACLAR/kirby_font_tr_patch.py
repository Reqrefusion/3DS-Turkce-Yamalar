...
def main():
    import argparse
    ap=argparse.ArgumentParser(description='Kirby Triple Deluxe BCFNT Türkçe glif çizici/enjektörü v12 (runtime-safe CMAP + büyük I orta-kesim tabanlı noktasız ı, yalnızca standart Python)')
